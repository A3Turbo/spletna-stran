...
// ─── Eyebrow label ───────────────────────────────────────────────────────────
export function Eyebrow({ children, color = colors.tomato }: { children: React.ReactNode; color?: string }) {
  return (
...
// ─── Horizontal rule ─────────────────────────────────────────────────────────
export function Rule({ color = colors.rule, my = 14 }: { color?: string; my?: number }) {
  return <View style={{ height: 1, backgroundColor: color, marginVertical: my }} />;
}
